...
class PatientsController extends Controller
{
     ...
     public function store(Request $request)
     {
         ...
         $patients = PatientsCovid::create($validateData);
     ...
     {
         $patients = PatientsCovid::find($id);
     ...
     public function search($name) 
     {
         ...
         $patients = PatientsCovid::where('name', 'like', '%' .$name. '%')->get();
     ...
     public function status($status) 
     {
         ...
         $patient = PatientsCovid::where('status', 'like', '%' .$status. '%')->get();
